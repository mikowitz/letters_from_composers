voice = \relative c'' {
  ...
  R2. | %13
  \bar "||"
  r8 e,_(\mp a8.) r16 cs8( b16 a e4 | %14
  gs8 gs ~ \tuplet 3/2 { gs16[) r 
                           \shape #'(((.5 . 0) (0 . 2) (0 . 1) (0 . .5))
            ((0 . .25) (0 . 0) (0 . 0) (0 . 0))) PhrasingSlur
  ...
  fs8 g16 fs \tuplet 3/2 { e4 g8 } as,16 fs' fs8 ~ 16\)[ r 
  \shape #'(((0 . 0) (0 . 1) (0 . 2) (0 . 2))
  ...
  r2 
  \tuplet 3/2 { r8 
  \shape #'(((0 . 0) (0 . 1) (0 . 0) (0 . .5))
            ((0 . 2) (0 . 3) (0 . 2) (0 . -1))) PhrasingSlur
  ...
  \bar "||"
  r4 r4 d8_(\pp\fermata f,
  \tweak extra-offset #'(0 . .5)
  \fermata) | %32
  r4 \tuplet 3/2 { r8 
                   \shape #'((0 . 0) (0 . 1) (0 . .5) (0 . 0)) PhrasingSlur
                   e
                   \( f } e'4\)\breathe | %33
  r4 \tuplet 5/4 { 
    \shape #'((0 . 0) (0 . 1) (0 . 1) (0 . -2)) PhrasingSlur
    
    d16\( b8 cs16 e, ~ } e4\) | %34
  r4 r8 f_( g4) | %35
  r8 
      \shape #'((0 . 0) (0 . 2) (0 . 2) (0 . 0)) PhrasingSlur
  f16
  \( g af8^\markIt "morendo" g f g | %36
  f e e e ~ 4\)\fermata
}