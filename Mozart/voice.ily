voice = \relative c'' {
  ...
  e1\fermata) s8 * 5 | %3
  r4 r8 d4--\f 
  \tweak extra-offset #'(2 . -2.4)
  ^\markIt "con molta ira" e8-. f-. e-. d-. c-. b-. a-. g-. f-. c'4--\glissando( d,8-.) | %4
  s8 * 15 | %5
  ...
  \bar "!"
  gf\ff-^ a,!-. a-. | %9
  r8 f'\f( fs g,)-. fs-. e-. fs-. g-. a-. b-. cs-. d-. e-. g->( bf,-.) r bf-.\< 
  \omit Accidental
  bf-. bf-. | %10
  ...
  cs2 r8 | %24
  cs--\mf ds-- e--^\markIt "molto allarg." fs-- gs--\< as-- b-- cs-- | %25
  \bar "||"
  d!2\f-> ~ d16[ r d8]-- 8-- 8-- | %26
  \tuplet 3/2 { e f e } e16-> bf8. r8 d \tuplet 3/2 { e fs g } | %27
  fs16 as, \once\omit Accidental as8 ~ as4 r8 fs\mf^\markIt "dolce" g a! | %28
  \tweak TupletBracket.bracket-visibility ##t
  \tuplet 3/2 { b c! b} b16->^\markIt "cresc." f8 b16 d b cs8 ~ \tuplet 3/2 { cs d e } | %29
  \bar "||"
  g4->\ff f!-> a8-^ r8 r1 s8 * 5 | %30
  r4\fermata r8 d,8\mf( f-.)^\markIt "rit. e dimin." e-. d-. c-. b-. a-. g-. f-. | %31
  c'\mp--\glissando( d,-.) r1 | %32
  \newSpacingSection
  \override Score.SpacingSpanner.spacing-increment = #2.5
  r2 e4\mp( a g2 c^\markIt "rall." b | %33
  \bar "||"
  a2. ~ | %34
  a4) r4 a8_(\(\p^\markIt "cantabile e dolce" b) | %35
  c!4 f e | %36
    \newSpacingSection
